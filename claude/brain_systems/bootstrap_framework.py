...
class BootstrapFramework:
    ...
    def __init__(self):
        ...
        self.template_generators = {
            ...
            "domain_ingestor": self._generate_domain_ingestor_template,
            "specialized_brain": self._generate_specialized_brain_template,
            "working_memory": self._generate_working_memory_template,
            "automation_tools": self._generate_automation_tools_template
        }
